    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='device_img')),
            ],
            options={
                'verbose_name': 'Gerät',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(blank=True, null=True, verbose_name='Ende')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateTimeField(blank=True, null=True, verbose_name='Startzeit')),
                ('end_date', models.DateTimeField(blank=True, null=True, verbose_name='Endzeit')),
                ('Equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Buchungssystem.equipment', verbose_name='Gerät')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Benutzer')),
            ],
        ),
